class PagamentosController < ApplicationController
  ...
  # GET /pagamentos/new
  # GET /pagamentos/new?id_estadia=#
  def new
	@pagamento = Pagamento.new
	if params[:id_estadia].present?
		@pagamento.id_estadia = params[:id_estadia]
	end
  end
  ...
  def create
	...
	respond_to do |format|
	  if @pagamento.save
		format.html { redirect_to '/debitos/calcular?id_estadia=' + @pagamento.id_estadia.to_s, notice: 'Pagamento realizado com sucesso.' }
  ...
  private
	...
	def pagamento_params
	  params.require(:pagamento).permit(:data, :dias, :id_estadia)
	end
end
